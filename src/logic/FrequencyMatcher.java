...
public class FrequencyMatcher {
	...
	public Map frequencysearch(String cname) throws IOException {
		...
		File folder = new File("C:\\Users\\HP\\andoid_project\\computing\\src\\textfile\\");
		File[] listOfFiles = folder.listFiles();

		for (int i = 0; i < listOfFiles.length; i++) {
			if (listOfFiles[i].isFile()) {
				arrayList.add("C:\\Users\\HP\\andoid_project\\computing\\src\\textfile\\" + listOfFiles[i].getName());
			}
		}
